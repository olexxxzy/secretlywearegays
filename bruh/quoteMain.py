...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.plainTextEditCategory = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.plainTextEditCategory.setGeometry(QtCore.QRect(10, 10, 461, 31))
        self.plainTextEditCategory.setPlainText("")
        self.plainTextEditCategory.setObjectName("plainTextEditCategory")
        self.plainTextEditCategory.setReadOnly(True)
